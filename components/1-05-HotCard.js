...
export default ({ item, index }) => (
  ...
  >
    ...
    >
      <div style={{ maxWidth: "100%" }} className="font14 bold text-overflow-one c333">{item.title}</div>
      <div style={{ maxWidth: "100%" }} className="font12 text-overflow-one c666">{item.caption}</div>
    </div>
