      ...
      >
        <div className="flex jc-between ai-center">
          ...
          <div className="font16 c666 flex">
            <Btn
              onClick={this.handClickNew}
              con={
                <span
                  className={`mr5 pointer ${
                    type === "new" ? "c-main" : "c333"
                  }`}
                >
                  {rankingList.new}
                </span>
            ...
            <span>|</span>
            <Btn
              onClick={this.handClickHot}
              con={
                <span
                  className={`ml5 pointer ${
                    type === "hot" ? "c-main" : "c333"
                  }`}
                >
                  {rankingList.hot}
                </span>
        ...
        {list &&
          ...
          list.map(item => (
            <WrapLink href="/index" as="/" key={uuid()} className="text-left">
              <div
                className="flex mb10 pl10 pt20 pb15 pr20 h100 home-loanlist-hover pointer"
                style={{ width: "300px" }}
              >
                ...
                <div className="flex equal jc-between pl15">
                  <div className="flex column jc-between c333 font12">
                    ...
                    <div className="font12 lh120 text-overflow-1">
                      {item.content}
                    </div>
                  </div>
